...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'khfountain';//this will be your WCC username
      $dbUsr = 'khfountain';//this will be your WCC username
      $dbPass = 'KwFbKywK8Ss3';//this will be the password found in the video.
